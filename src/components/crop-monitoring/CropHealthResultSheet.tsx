                ...
                <section className="grid grid-cols-5 gap-4">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="mt-1 flex flex-col gap-[18px]">
                      ...
                      <div className="size-2 rounded-full bg-[#B26F3C]"></div>
                  ...
                  <div className="flex flex-col gap-1.5">
                    ...
                    <p className="font-neue text-sm text-[#423C59]">0.25</p>
                    <p className="font-neue text-sm text-[#423C59]">0.50</p>
                    <p className="font-neue text-sm text-[#423C59]">0.75</p>
                    <p className="font-neue text-sm text-[#423C59]">1.00</p>
                  </div>
                  <div className="col-span-3 flex flex-col gap-1.5">
                    ...
                    <p className="font-neue text-sm text-[#423C59]">
                      Healthy crop growth detected
                    </p>
                    <p className="font-neue text-sm text-[#423C59]">
                      Moderate stress indicators
                    </p>
                    <p className="font-neue text-sm text-[#423C59]">
                      Attention required for crop health
                    </p>
                    <p className="font-neue text-sm text-[#423C59]">
